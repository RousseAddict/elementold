#!/usr/bin/env python3
# Registers ImageViewerVC.swift in the traditional (non-synchronized-group)
# pbxproj: 4 insertion points, mirroring the existing RoomEvent.swift entries.
import sys
...
NEW = [
    ("ImageViewerVC.swift", "BB200026", "BB200027"),
]
